...
class EstimateCalorieEdit extends StatefulWidget {
  final String title;
  const EstimateCalorieEdit({Key key, this.title = "Estimate Calorie"}) : super(key: key);

  @override
  _EstimateCalorieEditState createState() => _EstimateCalorieEditState();
}

class _EstimateCalorieEditState extends ModularState<EstimateCalorieEdit, ClientsController> {
