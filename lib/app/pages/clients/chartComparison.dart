...
class ChartComparison extends StatefulWidget {
  //
  ChartComparison() : super();

  final String title = "Comparison Chart";

  @override
  ChartComparisonState createState() => ChartComparisonState();
}

class ChartComparisonState extends State<ChartComparison> {
  //
