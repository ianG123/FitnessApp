        ...
        return AlertDialog(
          content: Form(
              ...
              child: Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Text('Default Units', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.blue)),
                  SizedBox(height: 20,),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Imperial (eg: inches, miles, lbs)", style: TextStyle(fontSize: 15),),
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Metric (eg: cm, km, kgs)", style: TextStyle(fontSize: 15)),
                      Checkbox(value: isChecked, onChanged: (checked){
                        setState((){
                          isChecked = checked;
                        });
