...
class Businessgroup extends StatefulWidget {
  final String title;
  const Businessgroup({Key key, this.title = "Businesstab"}) : super(key: key);

  @override
  _BusinessgroupState createState() => _BusinessgroupState();
}

class _BusinessgroupState
    extends ModularState<Businessgroup, BusinesstabController> {
