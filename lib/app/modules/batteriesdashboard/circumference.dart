...
class CircumferenceT extends StatefulWidget {
  final String title;
  const CircumferenceT({Key key, this.title = "Businesstab"}) : super(key: key);

  @override
  _CircumferenceTState createState() => _CircumferenceTState();
}

class _CircumferenceTState
    extends ModularState<CircumferenceT, BatteriesdashboardController> {
                ...
                child: ListView(
                  ...
                  children: <Widget>[
                    ...
                    MyMenu(
                        ...
                        warna: Colors.blue),
                    MyMenutwo(
                        title: "Straight Knee Foot Raise",
                        icon: Icons.blur_circular_outlined,
                        warna: Colors.blue),
                    MyMenuthree(
                        title: "Wrist",
