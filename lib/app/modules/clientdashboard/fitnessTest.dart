...
class FitnessTest extends StatefulWidget {
  final String title;
  const FitnessTest({Key key, this.title = "Businesstab"}) : super(key: key);

  @override
  _FitnessTestState createState() => _FitnessTestState();
}

class _FitnessTestState
    extends ModularState<FitnessTest, ClientdashboardController> {
              ...
              child: Container(
                ...
                child: ListView(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(height: 15),
                    MyMenufour(title: "Notes", warna: Colors.blue),
                  ],
                ),
              ),
            ),
